...
for(const folder of ['year7','year8','year9','year10']){
 ...
 for(const [answer,target] of [['Geschäft','Geschäft, Unternehmen'],['sympathique','sympa (fam.) / sympathique'],['écouter','écouter (qn/qc)'],['Kumpel','Kumpel; Freund/in']])
 ...
 ok(Object.values(JSON.parse(w.localStorage.getItem('fr:lerntage'))||{}).some(n=>n>0),'practice day recorded');
